...
@Data
@Schema(name = "AlumnoVinculacionEmpresas", description = "DTO que representa la vinculación del alumno con empresas en el convenio/proyecto")
public class AlumnoVinculacionEmpresasDto implements Serializable {
