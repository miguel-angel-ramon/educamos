...
@Data
@Schema(name = "Convenios programas anexos", description = "Descripcion para el modelo de convenios proyectos anexos")
public class ConveniosProyectoAnexosDto implements Serializable {
