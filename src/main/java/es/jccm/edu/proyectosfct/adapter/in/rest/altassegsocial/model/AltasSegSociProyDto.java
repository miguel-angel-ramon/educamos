...
@Data
@Schema(name = "Altas Seguridad Social Proyectos", description = "Tabla que guarda los valores de un alumno de alta en la Seguridad Social Proyectos")
public class AltasSegSociProyDto implements Serializable {
