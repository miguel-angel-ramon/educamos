...
@Data
@Schema(name = "Gasto estado Flujo", description = "Descripcion para el modelo Gasto estado Flujo")
public class GastoEstadoFlujoSiguienteDto implements Serializable {
