...
@Data
@Schema(name = "Convenios a programas horario tramo", description = "Descripcion para el modelo de Convenios a programas horario tramo")
public class ConvProgHorTramoFctDto implements Serializable {
	...
	private ConvProgHorPeriodoFctDto periodoHorario;
