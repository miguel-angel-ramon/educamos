...
@Data
@Schema(name = "Convenios a programas horario alumnado", description = "Descripcion para el modelo de Convenios a programas horario alumnado")
public class ConveniosProgramasHorarioAlumnoFctDto implements Serializable {
	...
	private List<ConvProgHorPeriodoFctDto> horarioAlumno;

	@Schema(description = "Número total de horas del programa asociado al convenio")
