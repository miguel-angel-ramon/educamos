package es.jccm.edu.documentosGC.application.domain.registrosdocumentospreparatoria;
...
@Data
@Entity
@IdClass(RegSelDocPreparatoriaPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocPreparatoria implements Serializable {
