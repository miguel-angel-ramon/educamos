package es.jccm.edu.documentosGC.application.domain.registrosdocumentosnoformales;
...
@Data
@Entity
@IdClass(RegSelDocNoFormalesPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocNoFormales implements Serializable {
