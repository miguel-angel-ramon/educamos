package es.jccm.edu.documentosGC.application.domain.registrosdocumentosprimaria;
...
@Data
@Entity
@IdClass(RegSelDocPrimariaPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocPrimaria implements Serializable {
