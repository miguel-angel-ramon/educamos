package es.jccm.edu.documentosGC.application.domain.resgistrosdocumentoseso;
...
@Data
@Entity
@IdClass(RegSelDocESOPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocESO implements Serializable {
