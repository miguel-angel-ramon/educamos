package es.jccm.edu.documentosGC.application.domain.registrosdocumentoseini;
...
@Data
@Entity
@IdClass(RegSelDocEINIPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocEINI implements Serializable {
