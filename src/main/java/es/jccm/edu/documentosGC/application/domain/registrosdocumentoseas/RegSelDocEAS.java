package es.jccm.edu.documentosGC.application.domain.registrosdocumentoseas;
...
@Data
@Entity
@IdClass(RegSelDocEASPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocEAS implements Serializable {
