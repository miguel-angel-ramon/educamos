package es.jccm.edu.documentosGC.application.domain.registrosdocumentoselementales;
...
@Data
@Entity
@IdClass(RegSelDocElementalesPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocElementales implements Serializable {
