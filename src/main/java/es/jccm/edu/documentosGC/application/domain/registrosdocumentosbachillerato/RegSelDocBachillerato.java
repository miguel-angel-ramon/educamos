package es.jccm.edu.documentosGC.application.domain.registrosdocumentosbachillerato;
...
@Data
@Entity
@IdClass(RegSelDocBachilleratoPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocBachillerato implements Serializable {
