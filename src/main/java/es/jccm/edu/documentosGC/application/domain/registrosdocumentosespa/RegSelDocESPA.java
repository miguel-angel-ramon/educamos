package es.jccm.edu.documentosGC.application.domain.registrosdocumentosespa;
...
@Data
@Entity
@IdClass(RegSelDocESPAPK.class)
@Table(name="TLREGSELDOC")
public class RegSelDocESPA implements Serializable {
