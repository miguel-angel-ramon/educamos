package es.jccm.edu.documentosGC.adapter.in.rest.cursoacademicodoc.model;
...
@Data
@Schema(name = "Curso académico", description = "Descripcion para el modelo de Documentos GC")
public class CursoAcademicoDocDto implements Serializable {
